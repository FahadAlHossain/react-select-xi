...
export default function Subscribe() {
  return (
    <div>
      <div className="border-2 p-4 rounded-xl bg-transparent border-slate-300">
        <div
          className="bg-cover bg-white bg-no-repeat h-80 border-slate-200 rounded-xl flex justify-center items-center"
